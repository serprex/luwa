						...
						f:iff(i32, function()
							...
							f:iff(i32, function(tblbr)
								...
								f:block(function(noesc)
									...
									f:i32(49)
									f:sub()
									f:brtable(a, b, noesc, noesc, noesc, f, noesc, noesc, noesc, noesc, noesc, noesc, noesc, n, noesc, noesc, noesc, r, noesc, t, u, v, noesc, x, noesc, z, noesc)
								end) -- 'noesc
									f:unreachable()
								end) -- 'z
