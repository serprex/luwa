					...
					f:block(function(oploadtrue)
						f:block(function(oploadfalse)
							f:block(function(oploadnil)
								...
								f:add()
								f:store(pc)
								f:brtable(nop, oploadnil, oploadfalse, oploadtrue, opeq, opadd, opidx, opnot, oplen, opmktab, optabset, optabset, opret, opcall, opcallret, opconst, oploadlocal, opstorelocal)
							end) -- LOAD_NIL
							f:load(valstack)
							f:i32(NIL)
							f:call(pushvec)
