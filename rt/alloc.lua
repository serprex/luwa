...
newstr = export('newstr', func(i32, i32, function(f, sz)
	...
	f:switch(function()
		...
		f:i32(7)
		f:band()
	end, str.base+7&7, function(scopes)
		f:load(psz)
		f:i32(0)
		f:i32store(str.base)
		f:load(psz)
		...
		f:add()
		f:store(psz)
		f:br(scopes[str.base+3&7])
	end, str.base+6&7, function(scopes)
		f:load(psz)
		f:i32(0)
		f:i32store(str.base)
		f:load(psz)
		...
		f:br(scopes.sb7)
	end, str.base+5&7, function(scopes)
		f:load(psz)
		f:i32(0)
		f:i32store(str.base)
		f:load(psz)
		...
		f:br(scopes.sb7)
	end, str.base+4&7, function(scopes)
		f:load(psz)
		f:i32(0)
		f:i32store(str.base)
		f:br(scopes.sb7)
	end, str.base+3&7, function(scopes)
		f:load(psz)
		f:i32(0)
		...
		f:br(scopes.sb7)
	end, str.base+2&7, function(scopes)
		f:load(psz)
		f:i32(0)
		f:i32store16(str.base)
		f:br(scopes.sb7)
	end, str.base+1&7, function(scopes)
		f:load(psz)
		f:i32(0)
